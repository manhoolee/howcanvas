...
import { deleteAdjacentReference, insertReferenceAtSelection, removeActiveMention, serializeContentEditable, textBeforeCaret } from "@/lib/canvas/contenteditable-references";
...
export function CanvasConfigComposer({ value, inputs, onChange, onClose }: CanvasConfigComposerProps) {
    ...
    const insertReference = (input: NodeGenerationInput) => {
        ...
        insertReferenceAtSelection(editor, chip);
        closeMention();
            ...
            <div className="relative rounded-xl">
                ...
                <div
                    ...
                    onKeyDown={(event: KeyboardEvent<HTMLDivElement>) => {
                        ...
                        if ((event.key === "Backspace" || event.key === "Delete") && deleteAdjacentReference(event.key, "referenceNodeId")) {
                            event.preventDefault();
