...
安全策略英文原文见 [SECURITY.md](https://github.com/manhoolee/howcanvas/blob/main/SECURITY.md)。

请不要在公开 Issue 中直接发布漏洞细节、可利用代码、私密 API Key、截图中的敏感信息或真实用户数据。

## 提交流程

优先使用 GitHub 的私密漏洞报告或 Security Advisory。如果仓库没有开启对应入口，请发送邮件至 [AR2000@VIP.163.com](mailto:AR2000@VIP.163.com)，邮件标题建议使用：
