---
name: open-canvas
description: 打开 HowCanvas 在线或本地画布，并自动连接本地 Canvas Agent。用户要求打开、启动、进入或使用 HowCanvas 画布时使用。
---
...
```text
https://can.hoosland.com/canvas?mode=new&agentUrl=<Local URL>&agentToken=<Connect token>
```

## 本地版

1. 在 HowCanvas 项目中启动前端，并使用 Vite 输出的 `Local` 地址：
