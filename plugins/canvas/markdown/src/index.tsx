...
import type { CanvasNodeContentProps, CanvasPlugin, PluginRuntime } from "@infinite-canvas/plugin-sdk";
...
let sanitizeMarkdown = (value: string) => value;
...
function renderMarkdown(source: string): string {
    ...
    if (out === undefined) {
        out = sanitizeMarkdown(marked.parse(key));
...
export default definePlugin((runtime: PluginRuntime) => {
    sanitizeMarkdown = (value) => runtime.sanitizeHTML(value, "html");
    htmlCache.clear();
    return plugin;
});
